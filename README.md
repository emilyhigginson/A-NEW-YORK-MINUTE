...
A NEW YORK MINUTE was inspired by my friend group's mix of spontanity and indecisivness. It is a site designed to allow users to find something to do in the city in a minute or less. Users can also save spots to visit at a later date, write reviews for spots to save them to their profiles, and add new spots to the database. 
